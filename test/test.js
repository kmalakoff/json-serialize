...
$(document).ready(function() {
  ...
  test("JSON.serialize", function() {
    ...
    result = JSON.serialize(embedded_dates);
  ...
  test("JSON.deserialize", function() {
    var int_value = 123456, string_value = 'Hello', date_value = new Date(), result;
    var object = {
      _type:'SomeNamespace.SomeClass',
      int_value:int_value,
    ...
    var result = JSON.deserialize(object.date_value);
    ...
    result = JSON.deserialize(embedded_date_objects);
    ...
    result = JSON.deserialize(JSON.serialize(embedded_date_objects));
    ...
    var previous_json_field = JSON.deserialize.TYPE_FIELD;
    JSON.deserialize.TYPE_FIELD = 'type';
    var couch_class_instance_json = { type:'couch_class', key: 42, value: 'meaning'};
    var couch_class_instance = JSON.deserialize(couch_class_instance_json);
    ...
    couch_class_instance = JSON.deserialize(couch_class_instance_json);
